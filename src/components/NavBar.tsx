        ...
        <ul className="flex flex-col mt-[80px] justify-top items-left absolute top-0 left-0 w-full h-[400px] bg-gradient-to-r from-gray-700 via-gray-900 to-black text-gray-500">
          ...
          {typeof window !== "undefined" && token ? (
            <>
              ...
              <li className="nav-links flex items-center gap-2 h-8 bg-[#3C6997] w-28 hover:bg-blue-300 px-4 cursor-pointer capitalize font-medium text-white hover:scale-105 hover:text-white duration-200 link-underline text-left rounded-2xl ">
                <Link href="/dashboard">To app</Link> <FaChevronCircleRight />
              </li>
            </>
          ) : (
